...
public void LaunchBrowser() {
	...
	driver.get("https://vahan.parivahan.gov.in/");
...
//	Thread.sleep(5000);
	...
	for(int j=0;j<activelinks.size();j++) {
		try{HttpURLConnection connection = (HttpURLConnection) new URL(activelinks.get(j).getAttribute("href")).openConnection();
		connection.connect();
